...
async function getFramerOutput(url) {
    ...
    try {
        ...
        // console.log(framerContent);

        // // Generate AI output using langchain
        // const question = "You are given content from a Framer website. Provide a summary of the content in four sentences or less.";
