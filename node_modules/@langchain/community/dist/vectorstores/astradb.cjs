...
class AstraDBVectorStore extends vectorstores_1.VectorStore {
    ...
    constructor(embeddings, args) {
        ...
        const { token, endpoint, collection, collectionOptions, idKey, contentKey, batchSize, ...callerArgs } = args;
        this.astraDBClient = new astra_db_ts_1.AstraDB(token, endpoint);
